...
def audit_file_chip_seq_control_read_depth(value, system,
                                           condition=rfa('ENCODE3',
                                                         ...
                                                         'Roadmap')):
    '''
    An alignment file from the LungMap Processing Pipeline should have read depth
    ...
    if 'analysis_step_version' not in value:
        detail = 'LungMap Processed alignment file {} has '.format(value['@id']) + \
    ...
    if value['analysis_step_version']['software_versions'] == []:
        detail = 'LungMap Processed alignment file {} has no '.format(value['@id']) + \
        ...
        if control_to_target == 'empty':
            ...
            if 'assembly' in value:
                detail = 'Control alignment file {} mapped to {} assembly has {} '.format(
                    ...
                    read_depth) + \
                    'usable fragments. ' + \
                    'The minimum LungMap standard for a control of ChIP-seq assays targeting broad ' + \
            ...
            if 'assembly' in value:
                detail = 'Control alignment file {} mapped to {} assembly has {} '.format(
                    ...
                    read_depth) + \
                    'usable fragments. ' + \
                    'The minimum LungMap standard for a control of ChIP-seq assays targeting narrow ' + \
                    'histone mark {} '.format(control_to_target) + \
            ...
            if 'assembly' in value:
                detail = 'Control alignment file {} mapped to {} assembly has {} '.format(
                    ...
                    read_depth) + \
                    'usable fragments. ' + \
                    'The minimum LungMap standard for a control of ChIP-seq assays targeting ' + \
